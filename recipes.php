...
<html lang="es-419">
  <head>
    ...
    <meta name="description" content="Nuestras recetas para que seas un gran chef.">
    <meta name="author" content="Jurghan Ascarza">
    <meta name="copyright" content="Peruvian Foodies">
    <title>Recetas - Peruvian Foodies</title>
  ...
  <body>
    ...
    <section class="recipes">
      <div class="recipes__title">
        <p class="recipes__title-text">Recetas</p>

        <nav class="recipes__title-section">
          <a class="recipes__title-section-item" href="#suggested">Recomendado</a>
          <a class="recipes__title-section-item" href="#monthly_menu">Menú del mes</a>
          <a class="recipes__title-section-item" href="#starters">Entradas</a>
          <a class="recipes__title-section-item" href="#main_courses">Platos de fondo</a>
          <a class="recipes__title-section-item" href="#desserts">Postres</a>
          <a class="recipes__title-section-item" href="#drinks">Bebidas</a>
        </nav>
      </div>
        <div class="recipes__articles">
          ...
          <article class="recipes__article" id="starters">
            <div class="recipes__article-recipe">
              <div class="recipes__article-container">
                <p class="recipes__article-title">Entradas</p>
                <img class="recipes__article-img" src="img/recipes-images/ceviche.png" alt="Ceviche">
              </div>
          ...
          <article class="recipes__article" id="main_courses">
            <div class="recipes__article-recipe">
              <div class="recipes__article-container">
                <p class="recipes__article-title">Platos de fondo</p>
                <img class="recipes__article-img" src="img/recipes-images/aji_de_gallina.png" alt="Ají de gallina">
              </div>
          ...
          <article class="recipes__article" id="desserts">
            <div class="recipes__article-recipe">
              <div class="recipes__article-container">
                <p class="recipes__article-title">Postres</p>
                <img class="recipes__article-img" src="img/recipes-images/mazamorra_morada.png" alt="Mazamorra morada">
              </div>
          ...
          <article class="recipes__article" id="drinks">
            <div class="recipes__article-recipe">
              <div class="recipes__article-container">
                <p class="recipes__article-title">Bebidas</p>
